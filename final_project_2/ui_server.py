...
class Ui_MainWindow(object):
    ...
    # Manipulating the automatically generated code here
        self.tableWidget.setHorizontalHeaderLabels(["station_id", "alert_1", "alert_2", "update_time"])
        self.load_data()

    # This function created by me - getting data from sqlite and inserting into the table:
    def load_data(self):
    ...
    # # This function created by me - getting data from sqlite and REFRESHING the table:
