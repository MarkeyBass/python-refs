...
# save data function in case unexpected error occurred
def save_data():
    try:
...
# will treat all the unexpected exceptions - again not the best practice for final production.
# but ok - espatially with the save_data() in any case.
except (Exception,):
